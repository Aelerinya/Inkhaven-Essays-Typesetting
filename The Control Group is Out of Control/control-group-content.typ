...
#import "footnote.typ": custom-footnote

*I.*

Allan Crossman calls parapsychology the control group for science#custom-footnote[Allan Crossman, "Parapsychology: the control group for science," #emph[LessWrong], Dec 5, 2009].

That is, in let's say a drug testing experiment, you give some people the drug and they recover. That doesn't tell you much until you give some other people a placebo drug you _know_ doesn't work – but which they themselves believe in – and see how many of _them_ recover. That number tells you how many people will recover whether the drug works or not. Unless people on your real drug do significantly better than people on the placebo drug, you haven't found anything.

On the meta-level, you're studying some phenomenon and you get some positive findings. That doesn't tell you much until you take some other researchers who are studying a phenomenon you _know_ doesn't exist – but which they themselves believe in – and see how many of _them_ get positive findings. That number tells you how many studies will discover positive results whether the phenomenon is real or not. Unless studies of the real phenomenon do significantly better than studies of the placebo phenomenon, you haven't found anything.
...
The results are pretty dismal. Parapsychologists are able to produce experimental evidence for psychic phenomena about as easily as normal scientists are able to produce such evidence for normal, non-psychic phenomena. This suggests the existence of a very large "placebo effect" in science – ie with enough energy focused on a subject, you can _always_ produce "experimental evidence" for it that meets the usual scientific standards. As Eliezer Yudkowsky puts it:

#quote[Parapsychologists are constantly protesting that they are playing by all the standard scientific rules, and yet their results are being ignored – that they are unfairly being held to higher standards than everyone else. I'm willing to believe that. It just means that the standard statistical methods of science are so weak and flawed as to permit a field of study to sustain itself in the complete absence of any subject matter.]

These sorts of thoughts have become more common lately in different fields. Psychologists admit to a crisis of replication#custom-footnote[Brian Owens, "Psychologists do some soul-searching," #emph[Nature News Blog], Nov 8, 2012] as some of their most interesting findings turn out to be spurious. And in medicine, John Ioannides and others have been criticizing the research for a decade now and telling everyone they need to up their standards.

"Up your standards" has been a complicated demand that cashes out in a lot of technical ways. But there is broad agreement among the most intelligent voices I read#custom-footnote[John P. A. Ioannidis, "Why most published research findings are false," #emph[PLoS Medicine], Aug 2005]#custom-footnote[lukeprog, "How to Fix Science," #emph[LessWrong], Mar 6, 2012]#custom-footnote[Jonah Lehrer, "The Truth Wears Off," #emph[The New Yorker], Dec 5, 2010]#custom-footnote[James C. Coyne, #emph[PLOS Mind the Brain] blog]#custom-footnote[Joseph P. Simmons, Leif D. Nelson and Uri Simonsohn, "False-Positive Psychology," #emph[Psychological Science], Oct 17, 2011] about a couple of promising directions we could go:
...
10. Stricter effect size criteria. It's easy to get small effect sizes in _anything_.
...
Well, what now, motherfuckers?#custom-footnote[Daryl Bem et al., "Feeling the future: A meta-analysis of 90 experiments on the anomalous anticipation of random future events," #emph[F1000Research], 2016]
...
You might remember Bem as the prestigious establishment psychologist who decided to try his hand at parapsychology and to his and everyone else's surprise got positive results. Everyone had a lot of criticisms, some of which were very very good#custom-footnote[Tal Yarkoni, "The psychology of parapsychology," talyarkoni.org, Jan 10, 2011], and the study failed replication several times#custom-footnote[Benjamin Radford, "Controversial ESP Study Fails Yet Again," #emph[Discovery News], Sep 12, 2012]. Case closed, right?

Earlier this month Bem came back with a meta-analysis of ninety replications from tens of thousands of participants in thirty three laboratories in fourteen countries confirming his original finding, p < 1.2 × 10#super[-10], Bayes factor 7.4 × 10#super[9], funnel plot beautifully symmetrical, p-hacking curve nice and right-skewed, Orwin fail-safe n of 559, et cetera, et cetera, et cetera.
...
This is _far_ better than the average meta-analysis. Bem has always been pretty careful and this is no exception. Yet its conclusion is that psychic powers exist.
...
_None_ of these commandments even _touch_ poor experimental technique – or confounding, or whatever you want to call it. If an experiment is confounded, if it produces a strong signal even when its experimental hypothesis is true, then using a larger sample size will just make that signal even stronger.
...
#quote[An opportunity to calculate an approximate answer to this question emerges from a Bayesian critique of Bem's (2011) experiments by Wagenmakers, Wetzels, Borsboom, & van der Maas (2011). Although Wagenmakers et al. did not explicitly claim psi to be impossible, they came very close by setting their prior odds at 10#super[20] against the psi hypothesis. The Bayes Factor for our full database is approximately 10#super[9] in favor of the psi hypothesis (Table 1), which implies that our meta-analysis should lower their posterior odds against the psi hypothesis to 10#super[11]]

Let me shame both participants in this debate.

Bem, you are abusing Bayes factor. If Wagenmakers uses your 10#super[9] Bayes factor to adjust from his prior of 10#super[-20] to 10#super[-11], then what happens the next time you come up with another database of studies supporting your hypothesis? We all know you will, because you've amply proven these results weren't due to chance, so whatever factor produced these results – whether real psi or poor experimental technique – will no doubt keep producing them for the next hundred replication attempts. When those come in, does Wagenmakers have to adjust his probability from 10#super[-11] to 10#super[-2]? When you get another hundred studies, does he have to go from 10#super[-2] to 10#super[7]? If so, then by conservation of expected evidence#custom-footnote[Eliezer Yudkowsky, "Conservation of Expected Evidence," #emph[LessWrong], Aug 13, 2007] he should just update to 10#super[+7] right now – or really to infinity, since you can keep coming up with more studies till the cows come home. But in fact he shouldn't do that, because at some point his thought process becomes "Okay, I already know that studies of this quality can consistently produce positive findings, so either psi is real or studies of this quality aren't good enough to disprove it". This point should probably happen well before he increases his probability by a factor of 10#super[9]. See Confidence Levels Inside And Outside An Argument#custom-footnote[Scott Alexander, "Confidence levels inside and outside an argument," #emph[LessWrong], Dec 15, 2010] for this argument made in greater detail.

Wagenmakers, you are overconfident. Suppose God came down from Heaven and said in a booming voice "EVERY SINGLE STUDY IN THIS META-ANALYSIS WAS CONDUCTED PERFECTLY WITHOUT FLAWS OR BIAS, AS WAS THE META-ANALYSIS ITSELF." You would see a p-value of less than 1.2 × 10#super[-10] and think "I bet that was just coincidence"? And then they could do another study of the same size, also God-certified, returning exactly the same results, and you would say "I bet that was just coincidence too"? YOU ARE NOT THAT CERTAIN OF ANYTHING. Seriously, _read the \@\#!\$ing Sequences_.
...
But as Bem points out, demanding high effect size limits our ability to detect real but low-effect phenomena. Just to give an example, many physics experiments – like the ones that detected the Higgs boson or neutrinos – rely on detecting extremely small perturbations in the natural order, over millions of different trials. Less esoterically, Bem mentions the example of aspirin decreasing heart attack risk, which it definitely does and which is very important, but which has an effect size lower than that of his psi results. If humans have some kind of _very weak_ psionic faculty that under regular conditions operates poorly and inconsistently, but does indeed exist, then excluding it by definition from the realm of things science can discover would be a bad idea.
...
Wiseman & Schlitz's Experimenter Effects And The Remote Detection Of Staring#custom-footnote[Richard Wiseman and Marilyn Schlitz, "Experimenter effects and the remote detection of staring," #emph[Parapsychology], Routledge, 2005] is my favorite parapsychology paper ever and sends me into fits of nervous laughter every time I read it.
...
Take a second to reflect on how this _makes no sense_. Two experimenters in the same laboratory, using the same apparatus, having no contact with the subjects except to introduce themselves and flip a few switches – and whether one or the other was there that day completely altered the result. For a good time, watch the gymnastics they have to do to in the paper to make this sound sufficiently sensical to even get published. This is the only journal article I've ever read where, in the part of the Discussion section where you're supposed to propose possible reasons for your findings, both authors suggest maybe their co-author hacked into the computer and altered the results.

While it's nice to see people exploring Bem's findings further, _this_ is the experiment people should be replicating ninety times. I expect _something_ would turn up.

As it is, Kennedy and Taddonio list ten similar studies#custom-footnote[James E. Kennedy and Judith L. Taddonio, "Experimenter effects in parapsychological research," #emph[Journal of Parapsychology], 1976] with similar results. One cannot help wondering about publication bias (if the skeptic and the believer got similar results, who cares?). But the phenomenon is sufficiently well known in parapsychology that it has led to its own host of theories about how skeptics emit negative auras, or the enthusiasm of a proponent is a necessary kindling for psychic powers.
...
Then there's Munder (2013)#custom-footnote[Ben, "Therapy allegiance in psychotherapy research," criticalscience.com, Apr 15, 2013], which is a meta-meta-analysis on whether meta-analyses of confounding by researcher allegiance effect were themselves meta-confounded by meta-researcher allegiance effect. He found that indeed, meta-researchers who believed in researcher allegiance effect were more likely to turn up positive results in their studies of researcher allegiance effect (p < .002).

It gets worse. There's a famous story#custom-footnote[Alix Spiegel, "Teachers' Expectations Can Influence How Students Perform," #emph[NPR Morning Edition], Sep 17, 2012] about an experiment where a scientist told teachers that his advanced psychometric methods had predicted a couple of kids in their class were about to become geniuses (the students were actually chosen at random). He followed the students for the year and found that their intelligence actually increased. This was supposed to be a Cautionary Tale About How Teachers' Preconceptions Can Affect Children.
...
This scientist – let's give his name, Robert Rosenthal – then investigated three hundred forty five different studies#custom-footnote[Robert Rosenthal, "Interpersonal expectancy effects: A 30-year perspective," #emph[Current Directions in Psychological Science], 1994] for evidence of the same phenomenon. He found effect sizes of anywhere from 0.15 to 1.7, depending on the type of experiment involved. Note that this could also be phrased as "between twice as strong and twenty times as strong as Bem's psi effect". Mysteriously, animal learning experiments displayed the highest effect size, supporting the folk belief that animals are hypersensitive to subtle emotional cues.

Okay, fine. Subtle emotional cues. That's way more scientific than saying "negative auras". But the question remains – what went wrong for Schlitz and Wiseman? Even if Schlitz had done everything short of saying "The hypothesis of this experiment is for your skin response to increase when you are being stared at, please increase your skin response at that time," and subjects had tried to comply, the whole point was that they didn't _know_ when they were being stared at, because to find that out you'd have to be psychic. And how are these rats figuring out what the experimenters' subtle emotional cues mean anyway? _I_ can't figure out people's subtle emotional cues half the time!

I know that standard practice here is to tell the story of Clever Hans#custom-footnote["Clever Hans," #emph[Wikipedia]] and then say That Is Why We Do Double-Blind Studies. But first of all, I'm pretty sure no one does double-blind studies with rats. Second of all, I think most social psych studies aren't double blind – I just checked the first one I thought of, Aronson and Steele on stereotype threat, and it certainly wasn't. Third of all, this effect seems to be just as common in cases where it's hard to imagine how the researchers' subtle emotional cues could make a difference. Like Schlitz and Wiseman. Or like the psychotherapy experiments, where most of the subjects were doing therapy with individual psychologists and never even saw whatever prestigious professor was running the study behind the scenes.
...
Except that I think the criteria for "replication" here were exceptionally loose. For example, Savva et al was listed as an "exact replication" of Bem, but it was performed in 2004 – seven years before Bem's original study took place. I know Bem believes in precognition, but that's going _too far_. As far as I can tell "exact replication" here means "kinda similar psionic-y thing". Also, Bem classily lists his own experiments as exact replications of themselves, which gives a big boost to the "exact replications return the same results as Bem's original studies" line. I would want to see much stricter criteria for replication before I relax the "preregister your trials" requirement.

(Richard Wiseman – the same guy who provided the negative aura for the Wiseman and Schiltz experiment – has started a pre-register site for Bem replications#custom-footnote[Richard Wiseman and Caroline Watt, "Replication Registry for Bem experiments," richardwiseman.com]. He says he has received five of them. This is very promising. There is also a separate pre-register for parapsychology trials in general#custom-footnote["Registry for Parapsychological Experiments," Koestler Parapsychology Unit, University of Edinburgh]. I am both extremely pleased at this victory for good science, and ashamed that my own field is apparently behind parapsychology in the "scientific rigor" department)
...
The motto of the Royal Society – Hooke, Boyle, Newton, some of the people who arguably invented modern science – was _nullus in verba_, "take no one's word".
...
Imagine having to conduct the global warming debate, except that you couldn't appeal to scientific consensus and statistics because scientific consensus and statistics hadn't been invented yet. In a world without science, _everything_ would be like that.

Heck, just look at _philosophy_.
...
And for a while this went _well_. People would drop things off towers, or see how quickly gases expanded, or observe chimpanzees, or whatever.
...
The highest level of the Pyramid of Scientific Evidence is meta-analysis. But a lot of meta-analyses are crap. This meta-analysis got p < 1.2 × 10#super[-10] for a conclusion I'm pretty sure is false, and _it isn't even one of the crap ones_. Crap meta-analyses look more like this#custom-footnote[James C. Coyne, "Editor Should Have Caught Bias and Flaws in Review," #emph[Psychology Today], Dec 5, 2011], or even worse.
