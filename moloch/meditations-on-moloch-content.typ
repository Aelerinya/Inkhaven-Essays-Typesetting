...
dream and croak in the fog! Moloch whose smoke-stacks and antennae crown
the cities!
...
Moloch is introduced as the answer to a question – C. S. Lewis’ question
in
#link("http://www.moronail.net/img/1392_lil_jon_philosophy_what")[Hierarchy Of Philosophers]
– #emph[what does it];? Earth could be fair, and all men glad and wise.
...
And Ginsberg answers: #emph[Moloch does it.]

There’s #link("http://principiadiscordia.com/book/45.php")[a passage] in
the #emph[Principia Discordia] where Malaclypse complains to the Goddess
about the evils of human society. "Everyone is hurting each other, the
planet is rampant with injustices, whole societies plunder groups of
their own people, mothers imprison sons, children perish while brothers
war."
...
demon causes everything – but because thinking of the system as an agent
throws into relief the degree to which the system #emph[isn’t] an agent.
...
will kill #emph[them];, and so on. Every single citizen hates the
system, but for lack of a good coordination mechanism it endures. From a
...
#underline[1. The Prisoner’s Dilemma];, as played by two very dumb
...
coordination is #emph[hard];. From a god’s-eye-view, we can agree that
cooperate-cooperate is a better outcome than defect-defect, but neither
prisoner within the system can make it happen.

#underline[2. Dollar auctions];. I wrote about this and even more
convoluted versions of the same principle in
#link("http://lesswrong.com/lw/dr9/game_theory_as_a_dark_art/")[Game Theory As A Dark Art];.
Using some
#link("http://en.wikipedia.org/wiki/Dollar_auction")[weird auction rules];,
you can take advantage of poor coordination to make someone pay \$10 for
a one dollar bill. From a god’s-eye-view, clearly people should not pay
\$10 for a on-er. From within the system, each individual step taken
might be rational.

#emph[\(Ashcans and unobtainable dollars!)]

#underline[3. The fish farming story] from my
#link("http://raikoth.net/libertarian.html")[Non-Libertarian FAQ 2.0];:
...
to operate his filter. Now one fish farm worth of waste is polluting the
lake, lowering productivity by \$1. Steve earns \$999 profit, and
...
\$300. Steve goes around to everyone, saying "Wait! We all need to make
a voluntary pact to use filters! Otherwise, everyone’s productivity goes
down."
...
wait for everyone else to sign such a pact but opt out himself. This can
lead to an undesirable equilibrium in which no one will sign such a
pact.
]
...
#underline[4. The Malthusian trap];, at least at its extremely pure
...
\(you’re one of those rats from
#link("http://www.amazon.com/gp/product/0689710682/ref=as_li_tl?ie=UTF8&camp=1789&creative=390957&creativeASIN=0689710682&linkCode=as2&tag=slastacod-20&linkId=BRZZD37E45RNQI3R")[#emph[The Rats of NIMH];];;).
...
advocating some action to stop
#link("http://en.wikipedia.org/wiki/Population_cycle")[the cycle] will
be outcompeted by their cousins for whom advocating #emph[anything] is a
waste of time that could be used to compete and consume.

For a bunch of reasons evolution is not quite as Malthusian as the ideal
...
#underline[5. Capitalism];. Imagine a capitalist in a cutthroat
...
so companies in an economic environment of #emph[sufficiently intense
...
wants to buy from – go bankrupt and die out along with their
#link("http://www.businessinsider.com/what-is-your-company-dna-2011-2")[company DNA];.
...
#emph[\(Moloch whose love is endless oil and stone! Moloch whose blood
is running money!)]

#underline[6.
#link("https://slatestarcodex.com/2014/06/28/book-review-the-two-income-trap/")[The Two-Income Trap];];,
...
#emph[\(Robot apartments! Invisible suburbs!)]

#underline[7. Agriculture];. Jared Diamond calls it
#link("http://discovermagazine.com/1987/may/02-the-worst-mistake-in-the-history-of-the-human-race")[the worst mistake in human history];.
Whether or not it was a mistake, it wasn’t an #emph[accident] –
...
flourishing – but in a state of #emph[sufficiently intense competition]
...
end up agriculturalists or
#link("http://squid314.livejournal.com/340809.html")[go the way of the Comanche Indians];.
...
#underline[8. Arms races];. Large countries can spend anywhere from 5%
...
#emph[\(Moloch the vast stone of war! Moloch whose fingers are ten
armies!)]

#underline[9. Cancer];. The human body is supposed to be made up of
...
proliferate and outcompete the other – so that only the existence of the
immune system keeps the natural incentive to turn cancerous in check.

#underline[10. The "race to the bottom"] describes
#link("http://en.wikipedia.org/wiki/Race_to_the_bottom")[a political situation where]
some jurisdictions lure businesses by promising lower taxes and fewer
...
outside force – usually social stigma. As a result, there’s not actually
a race to the bottom – the system can continue functioning at a
relatively high level – but it’s impossible to optimize and resources
...
#underline[11. Education];. In my essay on reactionary philosophy, I
...
their boss if it goes wrong – whether or not the college provides value
added. And colleges’ incentive is to do whatever it takes to get more
prestige, as measured in #emph[US News and World Report] rankings –
whether or not it helps students. Does this lead to huge waste and poor
education? Yes. Could the Education God notice this and make some
...
their own incentives, which are only partly correlated with education or
efficiency.
]
...
#underline[12. Science];. Same essay:

#quote(block: true)[
The modern research community #emph[knows] they aren’t producing the
best science they could be. There’s lots of publication bias, statistics
are done in a confusing and misleading way out of sheer inertia, and
replications often happen very late or not at all. And sometimes someone
will say something like "I can’t believe people are too dumb to fix
Science. All we would have to do is require early registration of
studies to avoid publication bias, turn this new and powerful
statistical technique into the new standard, and accord higher status to
scientists who do replication experiments. It would be really simple and
it would vastly increase scientific progress. I must just be smarter
than all existing scientists, since I’m able to think of this and they
aren’t."
...
system. No individual scientist has an incentive to unilaterally switch
to the new statistical technique for her own research, since it would
make her research less likely to produce earth-shattering results and
since it would just confuse all the other scientists. They just have an
incentive to want everybody else to do it, at which point they would
follow along. And no individual journal has an incentive to unilaterally
switch to early registration and publishing negative results, since it
would just mean their results are less interesting than that other
journal who only publishes ground-breaking discoveries. From within the
system, everyone is following their own incentives and will continue to
do so.
]

#underline[13. Government corruption];. I don’t know of anyone who
...
donations from corporations – or maybe
#link("https://slatestarcodex.com/2014/04/19/plutocracy-isnt-about-money/")[it isn’t];,
but officials #emph[think] it is. Officials who try to mess with
...
#underline[14. Congress];. Only 9% of Americans like it, suggesting a
#link("http://www.publicpolicypolling.com/main/2013/01/congress-somewhere-below-cockroaches-traffic-jams-and-nickleback-in-americans-esteem.html")[lower approval rating than]
cockroaches, head lice, or traffic jams. However,
#link("http://www.gallup.com/poll/162362/americans-down-congress-own-representative.aspx")[62% of people]
who know who their own Congressional representative is approve of them.
In theory, it should be #emph[really hard] to have a democratically
...
appeal to his or her constituency while throwing the rest of the country
under the bus – something at which they apparently succeed.
...
welfare, the government #emph[doesn’t] pay lots of corporate welfare.
...
I don’t think there are too many people who #emph[oppose] any of these
...
our current system isn’t a utopia is that #emph[it wasn’t designed by
...
civilization, it exists because of a quirk in
#link("http://journal.frontiersin.org/Journal/10.3389/fnbeh.2013.00206/full")[dopaminergic reward circuits];,
...
beware of that." People within the system, #emph[following the
incentives created by these facts];, think: "Let’s build a
forty-story-high indoor replica of ancient Rome full of albino tigers in
the middle of the desert, and so become slightly richer than people who
didn’t!"
...
#emph[uphill] surprisingly often. Why do things not degenerate more and
more until we are back at subsistence level? I can think of three bad
reasons – excess resources, physical limitations, and utility
maximization – plus one good reason – coordination.

#underline[1. Excess resources];. The ocean depths are a horrible place
with little light, few resources, and
#link("http://www.oddee.com/item_79915.aspx")[various horrible organisms]
dedicated to eating or parasitizing one another. But every so often, a
whale carcass falls to the bottom of the sea. More food than the
organisms that find it could ever possibly want. There’s a brief period
of miraculous plenty, while the couple of creatures that first encounter
the whale feed like kings. Eventually more animals discover the carcass,
the faster-breeding animals in the carcass multiply, the whale is
...
#link("https://slatestarcodex.com/2014/06/14/living-by-the-sword/")[since June 2014];)
...
Malthus. As Hanson puts it,
#link("http://www.overcomingbias.com/2009/09/this-is-the-dream-time.html")[this is the dream time];.

As long as resources aren’t scarce enough to lock us in a war of all
against all, we can do silly non-optimal things – like art and music and
philosophy and love – and not be outcompeted by merciless killing
machines most of the time.

#underline[2. Physical limitations];. Imagine a profit-maximizing
...
the slaves were voluntarily withholding their labor – we assume the fear
of punishment is enough to make them work as hard as they can – but
because the body has certain physical limitations that limit how mean
you can get away with being. Thus, the "race to the bottom" stops
somewhere short of the actual ethical bottom, when the physical limits
are run into.

John Moes, a historian of slavery,
#link("https://slatestarcodex.com/Stuff/manumission.pdf")[goes further and writes about]
how the slavery we are most familiar with – that of the antebellum South
...
themselves, we would be in #emph[really] bad shape. As it is they can
only do a small amount of damage per generation.

#underline[3. Utility maximization];. We’ve been thinking in terms of
...
Or suppose that there is some important value that is neither a value of
...
to "capitalists are greedy". I mean, sometimes they #emph[are] greedy.
But other times they’re just in a sufficiently intense competition where
...
good policymaking and electability, good policymaking #emph[has to] get
...
anything bad \(and statistically one of them will have to) it will be
all over the airwaves as "Convict released by Congressman’s policies
...
populations would be good policy – and it is – it will be very difficult
to implement.

#emph[\(Moloch the incomprehensible prison! Moloch the crossbone
soulless jailhouse and Congress of sorrows! Moloch whose buildings are
judgment! Moloch the stunned governments!)]

Turning "satisfying customers" and "satisfying citizens" into the
#emph[outputs] of optimization processes was one of civilization’s
greatest advances and the reason why capitalist democracies have so
outperformed other systems. But if we have bound Moloch as our servant,
the bonds are not very strong, and we sometimes find that the tasks he
has done for us move to his advantage rather than ours.

#underline[4. Coordination];.
...
Governments solve arm races #emph[within] a country by maintaining a
monopoly on the use of force, and it’s easy to see that if a truly
effective world government ever arose, international military buildups
...
competing for jobs, status, prestige, et cetera – there’s no reason they
should be immune to the same multipolar traps as everyone else, and
...
monarchy. A monarch is an unincentivized incentivizer. He
#emph[actually] has the god’s-eye-view and is outside of and above every
system. He has permanently won all competitions and is not competing for
anything, and therefore he is perfectly free of Moloch and of the
incentives that would otherwise channel his incentives into
predetermined paths. Aside from a few very theoretical proposals like my
#link("https://slatestarcodex.com/2013/05/06/raikoth-laws-language-and-society/")[Shining Garden];,
monarchy is the #emph[only] system that does this.
...
monarchists for the other, but I expect that
#link("https://slatestarcodex.com/2014/03/01/searching-for-one-sided-tradeoffs/")[like most tradeoffs]
...
#underline[Physical limitations] are most obviously conquered by
...
#link("https://www.amazon.com/Superintelligence-Dangers-Strategies-Nick-Bostrom/dp/0198739834/ref=as_li_ss_tl?ie=UTF8&linkCode=ll1&tag=slatestarcode-20&linkId=b90156dae75d7113131ab6d75fe00c0c")[#emph[Superintelligence];];:
...
wealth and fertility that we are currently observing on the global
scale, we must remind ourselves that this modern age is a brief slice of
history and very much an aberration. Human behavior has not yet adapted
to contemporary conditions. Not only do we fail to take advantage of
obvious ways to increase our inclusive fitness \(such as by becoming
sperm or egg donors) but we actively sabotage our fertility by using
birth control. In the environment of evolutionary adaptedness, a healthy
sex drive may have been enough to make an individual act in ways that
...
copyable, a population of emulations or AIs could double rapidly – over
the course of minutes rather than decades or centuries – soon exhausting
...
The idea of biological #emph[or] cultural evolution causing a mass
population explosion is a philosophical toy at best. The idea of
technology making it possible is both plausible and terrifying. Now we
see that "physical limits" segues very naturally into "excess resources"
...
#underline[Excess resources];, which until now have been a gift of
technological progress, therefore switch and become a casualty of it at
a sufficiently high tech level.

#underline[Utility maximization];, always on shaky ground, also faces
new threats. In the face of continuing debate about this point, I
#emph[continue] to think it obvious that robots will push humans out of
work or at least drive down wages \(which, in the existence of a minimum
...
Their
#link("http://www.patheos.com/blogs/lovejoyfeminism/2012/01/quiverfull-outbreeding-the-world.html")[articles explictly calculate]
...
and democracy, they’re optimizing for a #emph[proxy] of making us happy,
but that proxy can easily get uncoupled from the original goal.
...
#emph[\(Moloch whose name is the Mind!)]

There are a few people working on
#link("http://lesswrong.com/lw/1e/raising_the_sanity_waterline/")[raising the sanity waterline];,
...
#underline[Coordination] is what’s left. And technology has the
potential to seriously #emph[improve] coordination efforts. People can
use the Internet to get in touch with one another, launch political
movements, and
#link("https://slatestarcodex.com/2014/06/07/archipelago-and-atomic-communitarianism/")[fracture off into subcommunities];.
...
#link("http://panampost.com/belen-marty/2014/07/04/move-over-kickstarter-swarm-crypto-equity-is-the-next-frontier/")[crypto-equity];.
At this point I’ve gone from wanting to praise these inventors as bold
libertarian heroes to wanting to drag them in front of a blackboard and
making them write a hundred times "I WILL NOT CALL UP THAT WHICH I
CANNOT PUT DOWN"
]
...
#emph[contingent] stupidity of our current government to replace lots of
...
nanotech or nuclear incidents – we, as a civilization, are going to wish
we hadn’t established untraceable and unstoppable ways of selling
products.
...
optimizing for some random thing \(classically
#link("http://wiki.lesswrong.com/wiki/Paperclip_maximizer")[paper clips];)
because we weren’t smart enough to channel its optimization efforts the
right way. This is the ultimate trap, the trap that catches the
universe. Everything except the one thing being maximized is destroyed
utterly in pursuit of the single goal, including all the silly human
values.

Or it can end in Robin Hanson’s nightmare \(he doesn’t call it a
nightmare, but
#link("https://slatestarcodex.com/2013/04/06/poor-folks-do-smile-for-now/")[I think he’s wrong];)
...
out even the #emph[desire] for human values in their all-consuming
contest. What happens to art, philosophy, science, and love in such a
world? Zack Davis puts it with characteristic genius:
...
#emph[To ask of such forbidden science \
...
#emph[When obsolescence shall this generation waste, \
...
confident that this so, we must countenance the possibility that
human-like cognitive architectures are optimal only within the
constraints of human neurology \(or not at all). When it becomes
possible to build architectures that could not be implemented well on
biological neural networks, new design space opens up; and the global
optima in this extended space need not resemble familiar types of
mentality. Human-like cognitive organizations would then lack a niche in
a competitive post-transition economy or ecosystem.
...
miracles and technological awesomeness, with nobody there to benefit. A
...
#emph[\(Moloch whose eyes are a thousand blind windows!];)

Everything the human race has worked for – all of our technology, all of
our civilization, all the hopes we invested in our future – might be
...
#emph[\(Moloch whose fate is a cloud of sexless hydrogen!)]
...
Suppose that we agreed to allow #emph[almost] the entire accessible
universe to be converted into hedonium – everything except a small
preserve, say the Milky Way, which would be set aside to accommodate our
own needs. Then there would still be a hundred billion galaxies
dedicated to the maximization of \[the superintelligence’s own values\].
But we would have one galaxy within which to create wonderful
civilizations that could last for billions of years and in which humans
and nonhuman animals could survive and thrive, and have the opportunity
to develop into beatific posthuman spirits.
]
...
"Gnon" is
#link("http://www.xenosystems.net/the-cult-of-gnon/")[Nick Land’s]
...
#quote(block: true)[
#link("https://twitter.com/AnarchoPapist")[\@AnarchoPapist] Yes, the
Gods of the Copybook Headings are practically indistinguishable from
Gnon.

— Outsideness \(\@Outsideness)
#link("https://twitter.com/Outsideness/statuses/488189062939815936")[July 13, 2014]
]

These are of course the proverbs from
#link("http://www.kiplingsociety.co.uk/poems_copybook.htm")[Kipling’s eponymous poem]
– maxims like "If you don’t work, you die" and "The wages of sin is
Death". If you have somehow not yet read it, I predict you will find it
delightful regardless of what you think of its politics.
...
"If you don’t work, you die." Gotcha! If you #emph[do] work, you
#emph[also] die! Everyone dies, unpredictably, at a time not of their
own choosing, and all the virtue in the world does not save you.
...
one of Lovecraft’s less known short stories,
#link("http://www.dagonbytes.com/thelibrary/lovecraft/theothergods.htm")[The Other Gods];.
...
by
#link("http://foo.ca/wp/chick-tract-satire/who-will-be-eaten-first/")[eating you first];,
...
#quote(block: true)[
The thought that abstract ideas can be Lovecraftian monsters is an old
one but a deep one.

— Steven Kaas \(\@stevenkaas)
#link("https://twitter.com/stevenkaas/statuses/29750679694213120")[January 25, 2011]
]
...
his watery prison is a #emph[bad idea];. Maybe we should #emph[not do
that];."

That person will not be Nick Land. He is
#link("http://www.xenosystems.net/pythia-unbound/")[totally one hundred percent in favor]
of freeing Cthulhu from his watery prison and extremely annoyed that it
is not happening fast enough. I have #emph[such mixed feelings] about
Nick Land. On the grail quest for the True Futurology, he has gone 99.9%
of the path and then missed the #emph[very] last turn, the one marked
#link("http://wiki.lesswrong.com/wiki/Orthogonality_thesis")[ORTHOGONALITY THESIS];.
...
mildly embarrassed. If you do #emph[almost] everything right and then
miss the very last turn, you end up being eaten by the legendary Black
Beast of Aaargh whose ichorous stomach acid erodes your very soul into
gibbering fragments.
...
From #link("http://www.moreright.net/capturing-gnon/")[Capturing Gnon];:

#quote(block: true)[
Each component of Gnon detailed above had and has a strong hand in
creating us, our ideas, our wealth, and our dominance, and thus has been
good in that respect, but we must remember that \[he\] can and will turn
on us when circumstances change. Evolution becomes dysgenic, features of
the memetic landscape promote ever crazier insanity, productivity turns
to famine when we can no longer compete to afford our own existence, and
order turns to chaos and bloodshed when we neglect martial strength or
are overpowered from outside. These processes are not good or evil
overall; they are neutral, in the horrorist Lovecraftian sense of the
word \[…\]
...
sovereignty. These things are not to be construed as complete proposals;
we don’t really know how to accomplish any of this. They are better
understood as goals to be worked towards. This post concerns itself with
the "what" and "why", rather than the "how".
]
...
The liberal counterargument to that is that evolution is
#link("http://lesswrong.com/lw/kr/an_alien_god/")[a blind idiot alien god]
that optimizes for stupid things and has no concern with human value.
Thus, the fact that some species of wasps paralyze caterpillars, lay
their eggs inside of it, and have its young devour the still-living
paralyzed caterpillar from the inside doesn’t set off evolution’s moral
sensor, because evolution doesn’t #emph[have] a moral sensor because
...
evolutionary processes that cause societies to adopt patriarchy
#emph[still] have exactly as little concern for its moral effects on
women as the biological evolutionary processes that cause wasps to lay
...
art, happy families, and glorious adventures. I will take it as a given
that this telos is identical with "good" and "should".
...
dysgenic, insane, hungry, and bloody dark ages; or will the telos of man
prevail for a future of meaningful art, science, spirituality, and
greatness?
]
...
gardener who, while theoretically still subject to the law of the
jungle, is so dominant as to limit the usefulness of that model.
...
bioweapons research, you #emph[definitely] don’t research nanotechnology
or strong AI.

Everyone outside #emph[doesn’t] do those things. And so the only
question is whether you’ll be destroyed by foreign diseases, foreign
memes, foreign armies, foreign economic competition, or foreign
...
So here is Hurlock’s
#link("http://hurlock-151.tumblr.com/post/91738304666/on-capturing-gnon-and-naive-rationalism")[On Capturing Gnon And Naive Rationalism];.
...
Gnon", and somehow establish control over his forces, so that we can use
them to our own advantage. Capturing or creating God is indeed a classic
transhumanist fetish, which is simply another form of the oldest human
ambition ever, to rule the universe.
...
to the naive rationalist view of humanity and civilization. The
consensus opinion regarding human society and civilization, of all
...
execution of any human design". Contrary to the naive rationalist view
of civilization as something that can be and is a subject to explicit
human design, the representatives of the tradition of Spontaneous Order
maintain the view that human civilization and social institutions are
the result of a complex evolutionary process which is driven by human
interaction but not explicit human planning.
...
submit to them. Refusing to do so will not deter these forces in any
way. It will only make our life more painful and unbearable, possibly
leading to our extinction. Survival requires that we accept and submit
to them. Man in the end has always been and always will be little more
than a puppet of the forces of the universe. To be free of them is
impossible.
...
Not personally – I mean, I wouldn’t object if someone personally offered
me the job, but I don’t expect anyone will. I would like humans, or
something that respects humans, or at least gets along with humans – to
have the job.
...
#link("http://www.amazon.com/gp/product/0199678111/ref=as_li_tl?ie=UTF8&camp=1789&creative=390957&creativeASIN=0199678111&linkCode=as2&tag=slastacod-20&linkId=MLLWPLYEFTPAGE4X")[#emph[Superintelligence];]
...
title of most powerful entity – permanently. In the very near future, we
are going to lift #emph[something] to Heaven. It might be Moloch. But it
might be something on our side. If it’s on our side, it can #emph[kill
Moloch dead];.
...
In the
#link("http://www.amazon.com/gp/product/0765347539/ref=as_li_tl?ie=UTF8&camp=1789&creative=390957&creativeASIN=0765347539&linkCode=as2&tag=slastacod-20&linkId=BZSMMGHFLI7TQTEK")[#emph[Kushiel] books];;,
his name was Elua. He is the god of flowers and free love and all soft
and fragile things. Of art and science and philosophy and love. Of
#link("https://slatestarcodex.com/2014/02/23/in-favor-of-niceness-community-and-civilization/")[niceness, community, and civilization];.
...
who oppose Him tend to find Themselves meeting with a #emph[surprising]
...
#emph["It is only a
#link("http://hpmor.com/chapter/45")[childish thing];, that the human
species has not yet outgrown. And someday, we’ll get over it."]
...
— 앳켄스 탭 \(\@tabatkins)
#link("https://twitter.com/tabatkins/statuses/449588994305581056")[March 28, 2014]
]

\
#emph[I think this is an #underline[excellent] battle cry]
...
minds of my generation identify a problem and #emph[get to work];.
...
#emph[\[Also available as podcast
#link("http://sscpodcast.libsyn.com/meditations-on-moloch")[here] This
post is represented by an NFT
#link("https://zora.co/scottalexander/2143")[here];\]]
