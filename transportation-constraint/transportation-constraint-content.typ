...
#figure(
  image("sinai.png", width: 50%),
  caption: [_Green triangle on the left is the Nile river delta in Egypt; green chunk in the upper right is Israel. The big desert peninsula between them is the Sinai._]
)

*Option 1: carry it*

A physically-active human needs about 3 lbs of food per day. (Modern hikers can probably find lighter calorie-dense foodstuffs, but we're talking ancient history here.) Water requirements vary; 5 lbs is a minimum, but the US Army Quartermaster Corps recommends 20 lbs/day when marching through a hot desert. Alexander's army crossed the desert in 7 days. Food might be reasonable, but to carry the water would mean 7\*20 = 140 lbs per person, _plus_ 50+ lbs of armor, weapons, etc.

When I go hiking, I aim for a 20-30 lb pack. US marines are #link("https://www.popularmechanics.com/military/research/a25644619/soldier-weight/")[apparently expected] to be able to carry 150 lbs for 9 miles - quite a bit less than the 20+ miles/day Alexander's army managed, and with no comment on how long the marine in question might need to rest afterwards. (Also, I'm not sure I trust that source - 150 lbs for 9 miles sounds unrealistic to me, and if it's true then I'm _very_ impressed by marines.)
...
The above numbers are drawn from Donald Engels' book #link("https://smile.amazon.com/Alexander-Great-Logistics-Macedonian-Army/dp/0520042727/")[Alexander the Great and the Logistics of Macedonian Army]. But it tells us a lot more about the world than just the logistics of one particular ancient army.
...
- #link("https://www.ers.usda.gov/webdocs/publications/45165/41077_err160.pdf?v=0")[This USDA study] shows rates on produce transport, typically about 7-20 cents per pound (see figure 6). The Smart & Final grocery store near me sells the cheaper produce items looked at in that study (bell peppers, cantaloupes, tomatoes, oranges) for 70-100 cents per pound, so transport alone is roughly 10-20% of the cost-to-consumer.
- What about transporting humans? #link("https://www.visualcapitalist.com/average-commute-u-s-states-cities/")[Average commute in the US] is \~30 minutes each way; driving is usually in the 20-30 minute range, while public transit is usually 30-50. Assuming 8 hr workdays, that means commutes are typically \~10-20% of our work-hours.
- The bureau of transportation #link("https://www.bts.gov/transportation-economic-trends/tet-2018-chapter-2-contribution-economy")[estimates] transport at 5.6% of the US economy for a very narrow measure, or 8.9% with a broader measure (though this still excludes non-market transport costs like e.g. commute time).
